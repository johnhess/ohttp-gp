...
namespace ohttp {
    ...
    DecapsulationErrorCode decapsulate_request(
      ...
      // The rest is the ciphertext aka "HPKE-Protected Request"
      ...
      // For what it's worth, the CT is the same length generated by this
      // library and toyclient.  POST https://jthess.com/ "foo" is 47 bytes of CT.
